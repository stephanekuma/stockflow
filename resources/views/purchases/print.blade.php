    ...
    <div class="cec-invoice-container">
        ...
        <div class="cec-header">
            <div class="cec-header-left">
                <h1 class="cec-title">{{ __('PURCHASE INVOICE') }}</h1>
                <div class="cec-invoice-details">
                    <p><strong>{{ __('Invoice #') }}:</strong> {{ $purchase->invoice_number ?? 'N/A' }}</p>
                    <p><strong>{{ __('Date') }}:</strong> {{ $purchase->purchased_at?->format('d/m/Y') ?? 'N/A' }}
                    </p>
                    <p><strong>{{ __('Reference') }}:</strong> PUR-{{ $purchase->id ?? 'N/A' }}</p>
                </div>
            </div>
        ...
        <div class="cec-company-info">
            <div class="cec-billed-from">
                <h2 class="cec-section-title">{{ __('SUPPLIER INFORMATION') }}</h2>
        ...
        <div class="cec-items-section">
            <h2 class="cec-section-title">{{ __('PURCHASE DETAILS') }}</h2>
