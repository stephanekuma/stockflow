<x-filament::widget>
    <div class="p-4 bg-white rounded-lg shadow flex flex-col gap-2">
        <h3 class="text-lg font-bold">Synthèse des dettes clients</h3>
        <div class="flex flex-col gap-1">
            ...
            <div class="flex justify-between">
                ...
                <span class="font-semibold text-orange-600">{{ number_format($totalRemaining, 0, ',', ' ') }} F CFA</span>
            </div>
            <div class="flex justify-between">
                <span>Dettes en retard</span>
                <span class="font-semibold text-red-600">{{ $overdueDebts }}</span>
            </div>
        </div>
    </div>
</x-filament::widget>
